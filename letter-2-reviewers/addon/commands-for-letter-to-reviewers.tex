...
% Command for new Reviewer's header
\newcounter{thereviewer}
\newcommand{\ReviewerSection}[0]{\refstepcounter{thereviewer}\section*{Reviewer \Roman{thereviewer}}}
% Counter for comments
\newcounter{commentcnt}
\counterwithout*{commentcnt}{thereviewer}
...
\makeatletter
\renewcommand{\thecommentcnt}{\ifnum\c@thereviewer>0%
	\Roman{thereviewer}.\fi%
	\arabic{commentcnt}}
...
%
\newenvironment{GuestEditorComment}[1][]{\noindent\begin{minipage}[t]{\textwidth}\noindent \textbf{Comment \refstepcounter{commentcnt}{\thecommentcnt}%
% If an optional argument is passed, it is used as the label of the environment
\ifx\empty#1\relax\else#1\fi% 
~(Guest Editor): } \begin{quotation}\noindent\begin{em}}{\end{em}\end{quotation}\vspace{1ex}\end{minipage}}
%
\newenvironment{AssociateEditorComment}[1][]{\noindent\begin{minipage}[t]{\textwidth}\noindent \textbf{Comment \refstepcounter{commentcnt}{\thecommentcnt}%
% If an optional argument is passed, it is used as the label of the environment
\ifx\empty#1\relax\else#1\fi% 
~(Associate Editor): } \begin{quotation}\noindent\begin{em}}{\end{em}\end{quotation}\vspace{1ex}\end{minipage}}
%
\newenvironment{AreaEditorComment}[1][]{\noindent\begin{minipage}[t]{\textwidth}\noindent \textbf{Comment \refstepcounter{commentcnt}{\thecommentcnt}
%
% If an optional argument is passed, it is used as the label of the environment
\ifx\empty#1\relax\else#1\fi% 
...
% If an optional argument is passed, it is used as the label of the environment
\ifx\empty#1\relax\else#1\fi% 
~(Editor): } \begin{quotation}\noindent\begin{em}}{\end{em}\end{quotation}\vspace{1ex}\end{minipage}}
%
\newenvironment{EditorInChiefComment}[1][]{\noindent\begin{minipage}[t]{\textwidth}\noindent \textbf{Comment \refstepcounter{commentcnt}{\thecommentcnt}%
% If an optional argument is passed, it is used as the label of the environment
\ifx\empty#1\relax\else#1\fi% 
~(Editor in Chief): } \begin{quotation}\noindent\begin{em}}{\end{em}\end{quotation}\vspace{1ex}\end{minipage}}
%
\newenvironment{MetaReviewComment}[1][]{\noindent\begin{minipage}[t]{\textwidth}\noindent \textbf{Comment \refstepcounter{commentcnt}{\thecommentcnt}%
% If an optional argument is passed, it is used as the label of the environment
\ifx\empty#1\relax\else#1\fi% 
~(Meta-review): } \begin{quotation}\noindent\begin{em}}{\end{em}\end{quotation}\vspace{1ex}\end{minipage}}
%
\newenvironment{Answer}{\noindent \textbf{Answer: }}{\par\vspace{1cm}}
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Revision excerpt box
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newtcolorbox{RevisionExcerpt}{
  enhanced,
  breakable,
  colback=RoyalBlue!6,
  ...
  before skip=8pt,
  after skip=8pt,
  fontupper=\color{RoyalBlue}\small,
  title={Revised manuscript excerpt},
...
\newenvironment{NoteForAuthors}%
  {\ifoptiondraft{%
      \begin{tcolorbox}[enhanced,breakable,colback=gray!10,colframe=gray!60!black,boxrule=0.4pt,left=4pt,right=4pt,top=4pt,bottom=4pt,title=Note]%
      \color{orange}\begin{em}%
    }{}%
  }%
  {\ifoptiondraft{%
      \end{em}\end{tcolorbox}%
    }{}%
  }
%
