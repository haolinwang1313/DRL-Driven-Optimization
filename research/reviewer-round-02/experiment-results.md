...
- Current remote physical batch status: `running`.
...
- Balanced DDPG mean projection distance = 0.3294.

## Physical validation and cross-climate results
- Physical validation status: `running`.
- Physical job id: `981003a345cc`.
- Annual irradiance status: `pending`.
- Climate sensitivity status: `blocked`.
- Climate blocker or note: `baseline physical validation results not yet collected`.
...
- Climate: `artifacts\reviewer_round_02\20260625_round2_closure\climate\climate_sensitivity_summary.csv` for the current blocked state.