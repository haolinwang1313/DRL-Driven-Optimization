...
\caption{Seed-level DDPG training assessment across the three preference scenarios.}
...
EG rank stability is high across the tested climates, with Spearman rho = 1.0 for Beijing, Guangzhou, and Harbin. H rank stability is low, with Spearman rho = 0.2 for Beijing, 0.4 for Guangzhou, and 0.2 for Harbin. EUIt rank stability is high for Beijing and Guangzhou but low for Harbin, with Spearman rho = 0.2. These results motivate target-specific climate-sensitivity interpretation for the selected block set.
