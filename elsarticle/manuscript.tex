...
$\mathbf{a}$ & Action vector of 12 morphology variables \\
$\mathbf{s}$ & State vector of surrogate-predicted performance indicators \\
$y_1,y_2,y_3$ & Predicted EUIt, EG, and H responses \\
$\theta$ & Block orientation angle (deg) \\
$w_1,w_2,w_3$ & Reward weights for EUIt, EG, and H \\
$d_{\mathrm{weighted}}$ & Weighted distance to the utopian point $[0,1,1]$ \\
$R$ & Scalar reward used for policy learning \\
$\eta$ & Learning rate in surrogate training \\
